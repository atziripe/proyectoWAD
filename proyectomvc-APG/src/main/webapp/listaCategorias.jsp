            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="categoriaServlet?accion=grafica">Grafica Categoria</a></li>
                                ...
                                <tr>
                                    <td>
                                        <a class="btn btn-light btn-xs"
                                           href="categoriaServlet?accion=ver&id=<c:out value='${dto.entidad.idCategoria}'/>"
                                           >
                                    ...
                                    <td>
                                        <a 
                                            href="categoriaServlet?accion=actualizar&id=<c:out value='${dto.entidad.idCategoria}'/>"
                                            >
                                    ...
                                    <td>
                                        <a 
                                            href="categoriaServlet?accion=eliminar&id=<c:out value='${dto.entidad.idCategoria}'/>"
                                            >
