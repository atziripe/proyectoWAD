...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="categoriaServlet?accion=listaDeCategorias">Categorías</a></li>
        ...
        <!-- Datos Categoria-->
        <section class="page-section bg-dark" id="Category">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">Producto <c:out value='${product.entidad.nombreProducto}'/></h2>
                        ...
                        <div class="card bg-dark">
                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    <li class="list-group-item">ID: <c:out value='${product.entidad.idProducto}'/></li>
                                    <li class="list-group-item">Nombre: <c:out value='${product.entidad.nombreProducto}'/></li>
                                    <li class="list-group-item">Descripción: <c:out value='${product.entidad.descripcionProducto}'/></li>
                                    ...
                                    <li class="list-group-item">ID de categoria a la que pertenece: <c:out value='${product.entidad.idCategoria}'/></li>
                                </ul>                               
                            </div>
                        </div>
                    </div>
