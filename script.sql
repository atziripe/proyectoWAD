...
insert into pelicula values(6,3,'Por unos cuantos dolares más ','Cazarecompensas','B', 1965, 132,'Sergio Leone', 0, 0);
insert into pelicula values(6,3,'El bueno, el malo y el feo ','Cazarecompensas','B', 1966, 177,'Sergio Leone', 0, 0);
